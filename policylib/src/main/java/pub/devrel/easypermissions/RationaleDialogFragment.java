...
public class RationaleDialogFragment extends DialogFragment {
    ...
    private static List<PermissionPolicy> lists;
    ...
    public static RationaleDialogFragment newInstance(
        ...
        RationaleDialogConfig config = new RationaleDialogConfig(
                positiveButton, negativeButton, rationaleMsg, theme, requestCode, list, permissions);
...
//                new RationaleDialogClickListener(this, config, mPermissionCallbacks, mRationaleCallbacks);
        RationaleClickListener clickListener =
                new RationaleClickListener(this, config, mPermissionCallbacks, mRationaleCallbacks);
