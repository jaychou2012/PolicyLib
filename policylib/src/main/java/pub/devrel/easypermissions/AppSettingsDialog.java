 ...
 * Activity via {@link Activity#(int, int, Intent)}.
 * <p>
 * Use the {@link Builder} to create and display a dialog.
 */
public class AppSettingsDialog implements Parcelable, Policy.PolicyClick {
    ...
    public static class Builder {
         ...
         * Activity#(int, int, Intent)}. If you still don't have the right
         ...
         * in the calling Activity's {@link Activity#(int, int, Intent)} method.
