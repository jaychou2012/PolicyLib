...
public final class PermissionRequest {
    ...
    private final List<PermissionPolicy> list;
    ...
    public static final class Builder {
        ...
        private final int mRequestCode;
        private final String[] mPerms;
        private List<PermissionPolicy> lists;
         ...
         */
        public Builder(@NonNull Activity activity, int requestCode, List<PermissionPolicy> list,
        ...
        /**
         * @see #(Activity, int, String...)
         */
        public Builder(@NonNull Fragment fragment, int requestCode, List<PermissionPolicy> list,
                       @NonNull @Size(min = 1) String... perms) {
